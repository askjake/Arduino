...
#define REMOTE_2 A0        //INT PIN FOR REMOTE 2
#define REMOTE_3 A0        //INT PIN FOR REMOTE 3
#define REMOTE_4 A0        //INT PIN FOR REMOTE 4
#define REMOTE_5 A0        //INT PIN FOR REMOTE 5
#define REMOTE_6 A0        //INT PIN FOR REMOTE 6
#define REMOTE_7 A0        //INT PIN FOR REMOTE 7
#define REMOTE_8 A0       //INT PIN FOR REMOTE 8
...
//        pixels.show();
      ...
      case '?':  //HELP - COMMAND LISTING
        ...
        Serial.println("y - Android Sys Info");
...
if (debug) { Serial.print("CFG_REG: "); }
if (debug) { Serial.println(CFG_REG); }
if (debug) { Serial.print("KEY_CMD: "); }
